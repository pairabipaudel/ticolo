  ...
  return (
    <div>
      <div>
        ...
        <p>d. put under custody <strong>detained</strong></p>
        <p>e. found guilty <strong>convicted</strong></p>
        <p>f. breaking or disregarding rules or system <strong>violating</strong></p>
      ...
      <div>
        ...
        <p>It took me some time to adapt to the new school environment.</p>
        <strong>devote to</strong>
        <p>She devotes a lot of time to helping homeless animals.</p>
        <strong>refer to</strong>
        <p>Please refer to the handbook for detailed instructions.</p>
        <strong>reply to</strong>
        <p>I will reply to your email by the end of the day.</p>
        <strong>admire for</strong>
        <p>I admire her for always staying positive, no matter the situation.</p>
        <strong>apply for</strong>
        <p>He decided to apply for a scholarship to study abroad.</p>
        <strong>pray for</strong>
        <p>We all gathered to pray for the safety of the missing hikers.</p>
        <strong>scold for</strong>
        <p>The teacher scolded him for not completing his homework on time.</p>
        <strong>vote for</strong>
        <p>Many people came early to vote for their favorite candidate in the election.</p>
        <strong>aim at</strong>
        <p>This new program aims at improving students' communication skills.</p>
        <strong>arrive at</strong>
        <p>We plan to arrive at the station by 10 a.m. tomorrow.</p>
        <strong>glance at</strong>
        <p>She took a quick glance at her watch before entering the classroom.</p>
        <strong>look at</strong>
        <p>Please look at the board while I explain the lesson.</p>
        <strong>bring up</strong>
        <p>She decided to bring up the topic of climate change during the meeting.</p>
        <strong>agree on</strong>
        <p>We need to agree on a date for the school picnic.</p>
        <strong>comment on</strong>
        <p>The teacher asked us to comment on the main idea of the story.</p>
        <strong>concentrate on</strong>
        <p>I find it easier to concentrate on my studies when the room is quiet.</p>
        <strong>rely on</strong>
        <p>You can always rely on your friends for support in difficult times.</p>
        <strong>count on</strong>
        <p>I can count on my family to help me whenever I need it.</p>
        <strong>grow up</strong>
        <p>I want to grow up to become a doctor and help people.</p>
        <strong>escape from</strong>
        <p>The cat managed to escape from the locked room through the window.</p>
        <strong>recover from</strong>
        <p>She is slowly recovering from the flu and feels much better now.</p>
        <strong>resign from</strong>
        <p>He decided to resign from his job to pursue higher studies.</p>
        <strong>suffer from</strong>
        <p>Many people suffer from allergies during the spring season.</p>
        <strong>separate from</strong>
        <p>The teacher asked the students to separate from their groups and work individually.</p>
        <strong>worry about</strong>
        <p>Don't worry about the exam. Just do your best and stay calm.</p>
        <strong>argue about</strong>
        <p>They often argue about which movie to watch on weekends.</p>
        <strong>boast about</strong>
        <p>He likes to boast about his achievements to his classmates.</p>
        <strong>dream about</strong>
        <p>She often dreams about traveling to different countries one day.</p>
        <strong>acquaint with</strong>
        <p>The teacher acquainted the students with the new science project guidelines.</p>
        <strong>agree with</strong>
        <p>I completely agree with your opinion on protecting the environment.</p>
        <strong>charge with</strong>
        <p>The police charged him with theft after finding the stolen items in his possession.</p>
        <strong>trust with</strong>
        <p>She trusted him with the secret because she knew he would not tell anyone.</p>
        <strong>confuse with</strong>
        <p>I often confuse English words with similar pronunciation with each other.</p>
        <strong>believe in</strong>
        <p>I believe in working hard to achieve my goals.</p>
        <strong>involve in</strong>
        <p>She was involved in organizing the school cultural program.</p>
        <strong>succeed in</strong>
        <p>He worked hard and succeeded in passing the difficult exam.</p>
        <strong>specialize in</strong>
        <p>My cousin plans to specialize in computer science at university.</p>
...
However, like everything, social media has both positive and negative sides. On the negative side, it can lead to misinformation spreading quickly, causing confusion and panic. It can also contribute to cyberbullying, which harms individuals' mental health and well-being. Therefore, while social media has many benefits, it is important to use it responsibly and critically.</p>
      ...
      <div>
        ...
        <p>d. Manish and Richa moved the table <u>into</u> the dining room.</p>
      ...
      <div>
        ...
        <p>d. She ran <u>away from</u> home when she was eighteen. (towards/away from/down/across)</p>
        <p>e. Raindrops ran <u>down</u> the windscreen making it difficult to see the road.(into/up/down/over)</p>
        <p>f. Hemanta put the plate <u>onto</u> the table and began to eat his dinner. (onto/into/up/off)</p>
        <p>g. The frightened deer disappeared <u>into</u> the forest. (up/onto/into/toward)</p>
        <p>h. We were driving <u>towards</u> the City Centre when we had an accident. (up/into/towards/along)</p>
        <p>i. The smoke from the fire went <u>up</u> into the sky. (into/up/to/onto)</p>
      </div>
    </div>
  )
}

export default Mediaandsociety
