  ...
  return (
    <div>
      <div>
        ...
        <p>juju ------ a charm or fetish used by some West African people</p>
      ...
      <div>
        ...
        <p>The loud thunderstorm caused great terror among the children.</p>
        <br/>
        <p>c. Unbidden: Something that happens without being asked or invited; spontaneous or unexpected. </p>
          <p>Tears came to her eyes unbidden when she heard the sad news.</p>
          <br/>
          <p>d. persist : To continue firmly or stubbornly, especially despite difficulties or opposition.</p>
          <p>Even though the problem was hard, she persisted until she found the solution.</p>
          <br/>
          <p>e. devout : Showing deep religious feeling or commitment.</p>
          <p>She is a devout believer who visits the temple every week.</p>
          <br/>
          <p>f. banish : To send someone away from a place, usually as a punishment or to get rid</p>
          <p>The king decided to banish the traitor from the kingdom.</p>
          <br/>
          <p>g. creed : A set of beliefs or principles that guide a person or group.</p>
          <p>Their creed teaches kindness and honesty to everyone.</p>
          <br/>
          <p>h. hasten : To hurry or move quickly to do something.</p>
          <p>She hastened to finish her homework before the deadline.</p>
          <br/>
          <p>i. sober : Serious, thoughtful, and calm in behavior or attitude.</p>
          <p>After hearing the bad news, everyone had a sober and quiet conversation.</p>
          <br/>
          <p>j. scorn : A feeling or expression of strong dislike and disrespect.</p>
          <p>She looked at the broken toy with scorn because it was made cheaply.</p>
          <br/>
          <p>k. yearning : A strong feeling of wanting something or someone very much. </p>
          <p>After moving to a new city, she felt a deep yearning for her old friends.</p>
          <br/>
          <p>l. aloof : Not friendly or forthcoming; distant and reserved in manner.</p>
          <p>He stayed aloof from the argument, not wanting to get involved.</p>
          <br/>
          <p>m. swarthy : Having a dark complexion or skin tone.</p>
          <p>The traveler had a swarthy face from spending many months under the hot sun.</p>
          <br/>
      ...
      <div>
        ...
        <p>The minatory warning signs kept people away from the dangerous cliffs.</p>
        <strong>Placated</strong>
        <p>Origin: From Latin placare</p>
        <p>Meaning: To make somebody less angry or upset</p>
        <p>The mother placated her crying child with a warm hug.</p>
        <strong>Cajoled</strong>
        <p>Origin: From French cajoler</p>
        <p>Meaning: To persuade someone gently or by flattery</p>
        <p>He cajoled his friends into helping him with the project.</p>

        <strong>Antedates</strong>
        <p>Origin: From Latin ante </p>
        <p>Meaning: To occur earlier than something else; to predate</p>
        <p>The old manuscript antedates many modern books on the same topic.</p>

        <strong>Proliferated</strong>
        <p>Origin: From Latin prolifer</p>
        <p>Meaning: To increase greatly or multiply rapidly</p>
        <p>Social media platforms have proliferated rapidly in the last decade.</p>

        <strong>Philter</strong>
        <p>Origin: From Greek philtron </p>
      ...
      <div>
        ...
        <br/>
        <p>star- A celestial body that shines in the sky; a famous or outstanding person.</p>
        <br/>
        <p>Supermarket- A large store where many different types of food and goods are sold. </p>
        <br/>
        <p>Market- A place where people buy and sell goods; can be a physical or virtual place.</p>
        <br/>
        <p>Superhero- A fictional character with extraordinary powers who fights evil.</p>
        <br/>
        <p>Hero- A person admired for courage, achievements, or noble qualities.</p>
        <br/>
      ...
      <div>
        ...
        <p className='question'>a. According to the author, what are the four types of superstition?</p>
        ...
        <p className='question'>b. Which language is the word 'superstition' derived from? What does it mean?</p>
        <p>= The word 'superstition' is derived from the Latin word 'superstitio', which comes from 'superstare', meaning “to stand over in awe or fear.” It refers to standing in terror or excessive fear of the deity.</p>
        <p className='question'>c. How do psychologists understand superstition?</p>
        <p>= Psychologists think superstition is a habit or behavior that people feel forced to do, even if it doesn't make sense. It continues even in people who have mental problems like anxiety.</p>
        <p className='question'>d. How does superstition differ from religion?</p>
        <p>= The difference between religion and superstition is that religion is based on faith shared by a community and involves worship of God or gods. 
          </p><p>Superstition, on the other hand, is based on fear or blind beliefs and involves rituals or practices that are not based on reason or true faith.</p>
        <p className='question'>e. What is the belief of some people in Middle Europe about sneezing?</p>
        <p>Some people in Middle Europe believe that when a person sneezes, their soul leaves the body for a moment, so others quickly bless them to protect them from harm.</p>
        <p className='question'>f. In the author's view, why are people so fascinated about superstition?</p>
...
In conclusion, education plays a major role in reducing superstitious beliefs by promoting knowledge and reasoning. It may not wipe out superstition entirely, but it certainly helps people think more critically and make more informed choices.</p>
      ...
      <div>
        ...
        <p>Sadly, during illness, some people still visit faith healers or "witch doctors" instead of going to hospitals. They believe the illness is caused by evil spirits or curses. This can delay proper treatment and make the condition worse.</p>
      ...
      <div>
        ...
        <p>d. She <u>is having</u> (have) a shower in bathroom.</p>
        <p>e. How often <u>do you read</u> (you/read) a newspaper?</p>
        <p>f. I'm sorry, I <u>don't understand</u> (not/understand). Can you speak more slowly?</p>
        <p>g. You can turn off the radio. I <u>am not listening</u> (not/listen) to it.</p>
        <p>h. I usually <u>get up</u> (get up) at 5 o'clock every morning.</p>
      ...
      <div>
        ...
        <p>= The water is boiling. Can you turn it off?</p>
        <p>c. I must go now. It gets late.</p>
        <p>= I must go now. It is geting late.</p>
        <p>d. This sauce's tasting really good.</p>
        <p>= This sauce tastes really good.</p>
        <p>e. I'm thinking this is your key.</p>
        <p>= I think this is your key.</p>
        <p>f. Are you believing in God?</p>
        <p>= Do you believe in God?</p>
        <p>g. I usually go to school on foot.</p>
        <p>= I usually go to school on foot.</p>
        <p>h. Look! That man tries to open the door of her car.</p>
        <p>= Look! That man is trying to open the door of her car.</p>
        <p>i. The moon is going round the earth.</p>
        <p>= The moon goes round the earth.</p>
        <p>j. I'm getting hungry. Let's go and eat.</p>
        <p>= I'm getting hungry. Let's go and eat.</p>
      </div>
    </div>
  )
}

export default Humourandsatire
