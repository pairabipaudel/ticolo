  ...
  return (
    <div>
      <div>
        ...
        <p>d. to attract attention to or emphasize something important -  highlight</p>
        <p>e. arguing about things that are not important - bickering</p>
        <p>f. not having things or conditions that are usually considered necessary - deprivation</p>
        <p>g. continue to exist - persist</p>
        <p>h. soft loose flesh on a person's body - flab</p>
      ...
      <div>
        ...
        <p><strong>Highlighted: </strong>The teacher highlighted the important points in the book so we could remember them easily.</p>
        <p><strong>Bickering: </strong>The two brothers kept bickering over who got to play the game first.</p>
        <p><strong>Deprivation: </strong>Because of the storm, the village faced a deprivation of clean water for several days.</p>
        <p><strong>Persist: </strong>Even though the math problem was hard, she decided to persist and keep trying until she solved it.</p>
        <p><strong>flab: </strong>He started exercising every day to get rid of the flab on his stomach.</p>
      ...
      <div>
        ...
        <p>d. You may need to go shopping for clothes if you come down with a cold. <strong>True</strong></p>
        <p>e. Adenovirus-36 (AD-36) decreases the percentage of fat in the fat cells. <strong>False</strong></p>
        <p>f. Vaccination against infections could be used in the future to prevent obesity. <strong>True</strong></p>
        <p>g. People under severe stress can experience breathing difficulties. <strong>Not Given</strong></p>
        <p>h. A study indicates that mice that have never been on a diet choose fatty food, when given a choice between high-calorie or low-calorie food products. <strong>False</strong></p>
...
<p>4. Carry out proper vaccination programs to protect people from common diseases.</p>
      ...
      <div>
        ...
        <p>= Mental Health means how well we think, feel, and handle life's challenges. It includes our emotions, thoughts, and how we cope with stress. Good mental health helps us enjoy life, make good decisions, and handle problems without feeling overwhelmed. When our mental health is strong, we can build good relationships, do well in school or work, and stay physically healthy too. Here are ten tips to help keep your mind fresh and healthy:
          ...
          <p>3. Take breaks when you feel tired or stressed.</p>
          <p>4. Avoid alcohol, smoking, and drugs because they harm your brain and body.</p>
          <p>5. Get plenty of sunlight to improve your mood and energy. </p>
          <p>6. Learn to manage stress by practicing relaxation techniques.</p>
          <p>7. Stay active and exercise regularly to keep your body and mind strong.</p>
          <p>8. Do things you enjoy, like hobbies or sports, to feel happy.</p>
          <p>9. Connect with others and spend time with friends and family.</p>
...
export default Healthandexercise
