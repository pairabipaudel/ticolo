  ...
  return (
    <div>
      <div>
        ...
        <p>c. vista ------ vision</p>
        <p>d. undulating ------ wavy</p>
        <p>e. destined ------ predetermined</p>
      ...
      <div>
        ...
        <p>After losing his job, he was filled with despair but slowly started to look for new opportunities.</p>
        <p><strong>Beseech (Verb): </strong>To urgently and fervently ask or beg someone for something.</p>
        <p>I beseech you to help me with my project before the deadline.</p>
        <p><strong>Eloquent (Adjective): </strong>Fluent, persuasive, and expressive in speaking or writing.</p>
        <p>The speaker gave an eloquent speech that moved everyone in the audience.</p>
        <p><strong>whirl (Verb): </strong>To spin or rotate rapidly.</p>
        <p>The leaves began to whirl in the wind during the storm.</p>
        <p><strong>egoism (Noun): </strong>The practice of putting one's own interests and needs above those of others; excessive self-interest.</p>
        <p>His egoism made it difficult for him to work well with others on the team.</p>
        <p><strong>agony (Noun): </strong>Extreme physical or mental pain or suffering.</p>
        <p>She was in agony after twisting her ankle during the game.</p>
        <p><strong>delirious (Adjective): </strong>In a disturbed state of mind due to illness or excitement, often characterized by confusion or hallucinations.</p>
        <p>After running the marathon, he was so exhausted that he became delirious and could barely speak clearly.</p>
        <p><strong>delusive (Adjective): </strong>Giving a false or misleading impression; deceptive.</p>
        <p>His hopes of winning the lottery were delusive and not based on any realistic chance.</p>
        <p><strong>compensate (Verb): </strong>To give something, usually money, in recognition of loss, suffering, or work done.</p>
        <p>The company agreed to compensate the workers for the extra hours they had worked.</p>
        <p><strong>mortgage (Noun): </strong>A loan to buy property, paid back over time.</p>
        <p>She applied for a mortgage to purchase her new home.</p>
        <p><strong>brood (Verb): </strong>To think deeply and worry about something.</p>
        <p>He sat alone, brooding over his past mistakes.</p>
      ...
      <div>
        ...
        <p>d. The meals at Delight Café are <strong>satisfying</strong> /satisfied.</p>
        <p>e. I've got nothing to do. I'm boring/ <strong>bored</strong>.</p>
        <p>f. Tanka is very good at telling funny stories. He can be very <strong>amusing</strong> /amused.</p>
        <p>g. The teacher's explanation was <strong>confusing</strong> /confused. Most of the students didn't understand it.</p>
        <p>h. He is such a <strong>boring</strong> /bored person. He never wants to go out.</p>
      ...
      <div>
        ...
        <p>B: Not sure yet. Maybe I <u>will go</u> to Ilam. (will go/am going to)</p>
        <p>c. I think you <u>will</u> like this movie. (will /are going to)</p>
        <p>d. I can't join you at the party, I <u>am going to</u> be away for two weeks. (will /am going to)</p>
        <p>e. This exercise looks really hard. I <u>will</u> help you. (will/am going to)</p>
        <p>f. A: Hello. Can I speak to Sima, please?</p>
        <p>B: Just a minute. I <u>will</u> get her. (will/am going to)</p>
        <p>g. Perhaps she <u>will</u> pass the exam. (will/is going to)</p>
      ...
      <div>
        ...
        <p>Hema: Yes, I <u>am going to watch</u> it on Saturday. (watch)</p>
        <p>c. 'The alarm is ringing. It's making an awful noise.' 'OK, I <u>will switch</u> it off.' (switch)</p>
        <p>d. Do you think they <u>will like</u> the the presents we got for them? (like)</p>
        <p>e. 'Lok is starting university tomorrow.' 'What <u>is he going to</u> study?'(he/study)</p>
        <p>f. If I meet him, I <u>will tell</u> him the news. (tell)</p>
        <p>g. The phone is ringing. I <u>will answer</u> it. (answer)</p>
        <p>h. If you don't stop bullying her, I <u>will tell</u> the teacher. (tell)</p>
      </div>
    </div>
  )
}

export default Lifeandlove
