  ...
  return (
    <div>
      <div>
        ...
        <p>Nomadic ------ living the life of roaming</p>
      ...
      <div>
        ...
        <strong>mis</strong>
        <p>Misunderstand- He misunderstood the homework instructions and did the wrong assignment.</p>
        <p>Misplace- I always misplace my keys and spend time looking for them.</p>
        <strong>un</strong>
        <p>Unkind- It was unkind of him to laugh at her mistake.</p>
        <p>Unfair- It's unfair to blame her without knowing the full story.</p>
        <strong>in</strong>
        <p>Invisible- The stars became invisible during the day.</p>
        <p>Incorrect- The teacher marked the math problem as incorrect because the calculation was wrong.</p>
        <strong>pre</strong>
        <p>Preview- We watched the preview of the movie before it was released.</p>
        <p>Preheat- Don't forget to preheat the oven before baking the cake.</p>
        <strong>il</strong>
        <p>Illegal- It is illegal to drive without a license.</p>
        <p>Illogical- His explanation was illogical and didn't make any sense.</p>
        <strong>dis</strong>
        <p>Disagree- I disagree with your opinion, but I still respect it.</p>
        <p>Disappear- The magician made the coin disappear in his hand.</p>
        <strong>im</strong>
        <p>Impossible- It's impossible to lift that heavy rock alone.</p>
        <p>Impolite- It is impolite to interrupt someone while they are speaking.</p>
        <strong>Re</strong>
        <p>Rewrite- I had to rewrite my essay to make it better.</p>
        <p>Replay- We watched the replay of the exciting soccer match</p>
        <strong>ir</strong>
        <p>Irregular- The teacher noticed that his attendance was irregular last month.</p>
        <p>Irresponsible- It is irresponsible to leave your homework unfinished.</p>
        <strong>de</strong>
        <p>Deactivate- Please deactivate your account if you no longer want to use the service.</p>
        <p>Decrease- The company plans to decrease the prices of its products next month.</p>
        <strong>non</strong>
...
export default Ecologyanddevelopment
