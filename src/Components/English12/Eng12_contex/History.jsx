  ...
  return (
    <div>
      <div>
        ...
        <p className='question'>A. Match the words with their definitions/meanings.</p>
        <p>a. passion ------ any powerful or compelling emotion or feeling, as love or hate</p>
        <p>b. surveillance ------ continuous observation of a place, person, group, or ongoing activity in order to gather information</p>
        <p>c. integrity ------ the state of being whole, entire, or undiminished</p>
        <p>d. avuncular ------ like an uncle</p>
        <p>e. livelihood ------ a means of supporting one's existence</p>
        <p>f. fascination ------ powerful attraction</p>
        <p>g. innovation ------ an idea, practice, or object that is perceived as new</p>
        <p>h. panorama ------ an unobstructed and wide view of an extensive area in all directions</p>
        <p>i. resilience ------ the power or ability of a material to return to its original form, position, etc., after being bent, compressed, or stretched</p>
        <p>j. evacuation ------ the removal of people or things from an endangered area</p>
      </div>
      <hr/>
      <div>
      ...
      <div>
        ...
        <p className='question'>a. Many innocent people lose their lives in ruthless attacks every year. What do you think the governments should do to protect their people from such attacks and make the world a safer place to live? Discuss with your friends.</p>
...
By taking these steps, governments can work together to reduce violence and make the world a safer place for everyone.</p>
      ...
      <hr/>
      <div>
        <p className='question'>b. Revenge and violence are the integral parts of the history and civilization. They can't be ignored, only managed. Do you agree or not with this statement? Present your logic.</p>
...
This example shows how revenge and violence have led to destructive consequences and widespread suffering. Because such emotions and actions are deeply rooted in human nature and social dynamics, they cannot simply be ignored. Instead, it is necessary to recognize and manage them carefully through laws, diplomacy, and education to prevent escalation and promote peace.</p>
      ...
      <div>
        <hr/>
        <h3>Writing</h3>
        <p className='question'>A. Write a description of an event that you have recently witnessed.</p>
...
It was a scary moment, but everyone worked together to stay safe.</p>
      ...
      <hr/>
      <div>
        <p className='question'>B. Human life does not pass as one expects. You might have also gone through different but memorable incidents. Write an essay on “An Unforgettable Event in my Life' in about 500 words.</p>
...
The birth of my little sister is a memory I will never forget. It changed my life and made me feel closer to my family. Whenever I look at my sister now, I remember that day and the strong love that brought us all together.</p>
      ...
      <div>
        <hr/>
        <h3>Grammar</h3>
        <p className='question'>B. Complete these sentences with the correct prepositions.</p>
        <p>a. The relationship <strong>between</strong> the two boys has changed significantly over the past few years.</p>
        <p>b. In Nepal, many girls get married <strong>at</strong> an early age.</p>
        <p>c. I'm not <strong>in</strong>the mood for such silly games.</p>
        <p>d. There were no security personnel <strong>on </strong>duty at that time.</p>
        <p>e. The new smartphone is similar <strong>to</strong> the one I bought a few years ago.</p>
        <p>f. My dad insisted <strong> on </strong>taking the later train.</p>
        <p>g. People <strong>with </strong>ambition always try to achieve their goals, no matter what happens.</p>
        <p>h. Mr. Jenkins has been disabled all his life as a result <strong>of </strong>a childhood illness.</p>
        <p>i. We bought the TV because it was <strong>on</strong> sale.</p>
        <p>j. She has no understanding <strong>of</strong> how computers really work.</p>
        <p>k. I gave him my new T-shirt in exchange <strong>for</strong> a few cigarettes.</p>
        <p>l. The company is run<strong> by </strong>two people who hardly ever meet.</p>
        <p>m. All the celebrations and parties were called <strong>off</strong> because of the tragic accident.</p>
        <p>n. There was a great need <strong>of</strong> volunteers at the site of the crash</p>
      </div>
      <hr/>
      <div>
        <p className='question'>C. Complete the following text with correct prepositions.</p>
        <p>What are we seeing here? One very real possibility is that these are the educational consequences of the differences <strong>in</strong> parenting styles that we talked about <strong>in</strong> the Chris Langan chapter. Think back to Alex Williams, the nine-year-old whom Annette Lareau studied. His parents believe <strong>in</strong> connected cultivation. He gets taken <strong>to</strong> museums and gets enrolled <strong>in</strong> special programs and goes <strong>to</strong> summer camp, where he takes classes. When he's bored <strong>at</strong> home, there are plenty of books to read, and his parents see it as their responsibility to keep him actively engaged <strong>in</strong>the world <strong>for</strong> him. It's hard to see how Alex would get better <strong>at</strong> reading and math <strong>in</strong> the summer.</p>
      </div>
      <hr/>
      <div>
