  ...
  return (
    <div className="education-container">
      <section className="words-section">
        ...
        <p><strong>d.</strong> texture ------ the way food or drink tastes or feels in your mouth</p>
        <p><strong>e.</strong> cobbled ------ having a surface that is made of small round stones</p>
        <p><strong>f.</strong> flimsy ------ thin and easily torn</p>
        <p><strong>g.</strong> attire ------ clothes, especially fine or formal ones</p>
     ...
     <hr/>
      <section className="words-section">
        ...
        <p><strong>chronicle:</strong> A chronicle is a detailed and factual written account of important or historical events in the order they happened.</p>
        <p><strong>obituary:</strong> An obituary is a short article or notice published in a newspaper or online that reports the death of a person.</p>
        <p><strong>character sketch:</strong> A character sketch is a brief description or analysis of a person's personality, traits, and behavior.</p>
        <p><strong>profile:</strong> A profile is a short written description or summary of a person's background, skills, achievements, and personality.</p>
        <p><strong>memoir:</strong> A memoir is a written account of a person's personal experiences and memories, usually focusing on specific events or periods in their life.</p>
      </section>
      ...
      <section className="comprehension-section">
        ...
        <p>4. A new teacher in the school forbade Abdul Kalam to sit together with his Bramhin friend.</p>
        <p>5. Many students did not understand well of Sivasubramania Iyer's lecture.</p>
      ...
      <section className="writing-section">
        ...
        <p>Besides outdoor games, I also enjoyed playing chess with my elder brother and friends. We would spend hours thinking carefully about each move, trying to outsmart each other. Playing chess helped me improve my focus and taught me the importance of patience and strategy.</p>
        <p>One of the most memorable events from my childhood was the annual Tharu cultural festival in our town. The whole community came together to celebrate with traditional music, dance, and food. I loved watching the colorful performances and joining in with the dances. It was a time when everyone forgot their worries and just enjoyed being together.</p>
        <p>My childhood in Chitwan was simple but full of love, nature, and happiness. It shaped who I am today and gave me memories that I will cherish forever.</p>
      </section>
...
<br/>
      ...
      <section className="grammar-section">
        ...
        <p>d. In spite of his poor eyesight, <strong>he passed the driving license.</strong></p>
        <p>e. <strong>She feels nervous among new people</strong> though she is very sociable.</p>
        <p>f. <strong>He couldn't pass the exam</strong> in spite of his ten attempts.</p>
        <p>g. He refused to eat anything despite <strong>being very hungry.</strong></p>
        <p>h. He couldn't score good grades in the SEE exams in spite of <strong>studying very hard.</strong></p>
        <p>i. She accepted the job although <strong>she has no experience.</strong></p>
        <p>j. Even though we had planned everything carefully, <strong>we missed a lot of things.</strong></p>
      </section>
    </div>
  );
};
