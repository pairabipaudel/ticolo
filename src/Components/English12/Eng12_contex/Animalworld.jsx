...
<p> Sebika Paudel</p>
    ...
    <p>= The window is not going to be opened by the father.</p>
      ...
      <div>
        ...
        <p>d. The problem <strong>is being discussed</strong> (discuss) by the subject specialists at the moment.</p>
        <p>e. By the time I came back, the task<strong>has been finished </strong> (finish).</p>
        <p>f. Women <strong>are said </strong>(say) to be happier than men.</p>
        <p>g. Look! The house <strong>had been destroyed</strong> (destroy) by the fire.</p>
        <p>h. The other three reports <strong>will be submitted</strong> (submit) by next month.</p>
        <p>i. Many people <strong>have been resuced</strong> (rescue) from the floods by the security persons this year.</p>
        <p>j. The state of Florida <strong>was hit</strong> (hit) by a hurricane that did serious damage.</p>
      </div>
    </div>
  )
}
