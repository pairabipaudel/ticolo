  ...
  return (
    <div>
      <div>
        ...
        <p>c. An examination of a body after death to determine the cause of death <strong>autopsy</strong> osyaput</p>
        <p>d. A musical composition or movement for five instruments or voices <strong>quintet</strong> itqneut</p>
        <p>e. A severe life-threatening illness caused by a bacterium <strong>meningitis</strong> simetining</p>
        <p>f. An object that directs one's attention away from something else <strong>distraction</strong> nodsitstarc</p>
        <p>g. The action or process of becoming impaired or inferior in quality, functioning, or condition <strong>deterioration</strong> nedotietraroi</p>
        <p>h. Failing to perceive something<strong> impercipience</strong></p>
...
<p>Popular music with catchy melodies and simple lyrics, designed to appeal to a wide audience.</p>
<p><strong>Hip hop:</strong></p>

<p>A genre combining rhythmic spoken lyrics (rap) with DJing, beats, and street culture origins.</p>
<p><strong>Jazz:</strong></p>

<p>A music genre known for improvisation, complex harmonies, and a blend of blues and swing.</p>
...
<p>A loud, aggressive style of rock music with distorted guitars and intense vocals.</p>
<p><strong>Gospel music:</strong></p>

<p>Christian music that expresses faith, often with strong vocals and choir-style harmonies.</p>
<p><strong>Country music:</strong></p>

<p>A genre from the southern U.S. featuring guitars, storytelling lyrics, and themes of rural life.</p>
<p><strong>Grunge:</strong></p>

<p>A subgenre of rock with distorted guitars and raw vocals, often reflecting angst or rebellion.</p>
<p><strong>Breakbeat:</strong></p>

<p>An electronic music style that uses drum breaks and rhythmic sampling to create energetic beats.</p>
...
Even though he passed away on December 5, 1990, his music still lives in the hearts of millions. He may not be with us physically, but his voice and songs continue to inspire and heal. For me, Narayan Gopal is not just a singer, he is a legend whose voice carries the soul of Nepal.</p>
      ...
      <div>
        ...
        <p>d. His arguments are not based <strong>on</strong> truth.</p>
        <p>e. He has not contributed <strong>to</strong> the development of our nation.</p>
        <p>f. He died <strong>because</strong> of Corona at the age of thirty-five.</p>
        <p>g. The young generation of Nepali people don't take interest <strong>in</strong> politics.</p>
      ...
      <div>
        ...
        <p>d. She has been living in America <strong>since</strong> she got married.</p>
        <p>e. He has been playing video game <strong>for</strong> ten hours.</p>
        <p>f. She practices the Sitar every day <strong>for</strong> five hours.</p>
        <p>g. He lived in Jumla <strong>until</strong> he passed high school examinations.</p>
        <p>h. There is no chance of dry weather even today. It has rained <strong>since</strong> last Saturday.</p>
        <p>i. I can type 120 words <strong>in</strong> a minute.</p>
        <p>j. We take an early breakfast. It's generally ready <strong>by</strong> six in the morning.</p>
      </div>
    </div>
  )
}

export default Musicandcreation
