...
const Migrationanddiaspora = () => {
  return (
    <div>
      ...
      <p>d. <strong>assimilation</strong> the process of allowing somebody to become a part of a country or community</p>
      <p>e. <strong>misnomer</strong> a name or a word that is not appropriate or accurate</p>
      <p>f. <strong>confer</strong> to give somebody an award or a particular honour or right</p>
      <p>g. <strong>dormant</strong> not active or growing now but able to become active</p>
      <p>h. <strong>persecution</strong> the act of treating somebody in a cruel and unfair way</p>
      </div>
      <div>
        <hr/>
        <h3>Comprehension</h3>
      ...
      <div>
        ...
        <p>d. When I was very young, I <u>didn't use to</u> (not) like milk.</p>
        <p>e. She <u>would</u> call me after class for a chat.</p>
        <p>f. My mother <u>didn't used to</u> (not) wear glasses when she was at the university.</p>
        <p>g. When I was a child, we <u>used to</u> live in a village.</p>
        <p>h. On Sundays, My mother <u>would</u> wake up and go to the temple.</p>
        <p>i. How many friends <u>did you use to</u> have in class ten?</p>
        <p>j. My father <u>would</u> always read me bedtime stories before bed. </p>
      </div>
    </div>
  )
}

export default Migrationanddiaspora
