  ...
  return (
    <div>
      <div>
        ...
        <p>A. Complete the sentences with the correct words from the box below.</p>
      ...
      <div>
        <p>Define the following employment-related terms and use them in the sentences of your own.</p>
...
<p>The company conducted an assessment to find the best candidate for the job.</p>
      ...
      <div>
        <p>C. Based on their pronunciation, divide the following words into two groups so that the vowel sounds rhyme with here and hare.</p>
        <strong>Here</strong>
...
Available on request.
      ...
      <div>
        <hr/>
        <h3>Grammar</h3>
        <p>B. Rewrite the following sentences using the correct form of the verbs.</p>
       ...
       <div>
        <p>C. Change the following sentences into 'if sentences' as in the example.</p>
