  ...
  return (
    <div>
      <div>
        ...
        <p>d. transaction ------ an instance of buying ar selling of something</p>
        <p>e. initiatives ------ the power or opportunity to do something before others do</p>
        <p>f. launched ------ to introduce a new plan or product</p>
      ...
      <hr/>
       <div>
         ...
         <p>URLs:  Uniform Resource Locators</p>
         <p>EMVCo: Europay, MasterCard, and Visa Company</p>
       ...
       <div>
        ...
        <p>d. There are several models to the QR code payment service. <strong>True</strong></p>
...
Digital payment systems in Nepal are no longer just a modern option—they are becoming a necessity. With coordinated efforts and a focus on education, security, and accessibility, Nepal is well on its way to embracing a cashless future.</p>
       ...
       <div>
        ...
        <p>= Wh-question</p>
        <p>c. How many eggs do we need for this cake?</p>
        <p>= Wh-question</p>
        <p>d. Whose children are playing in the yard?</p>
        <p>=  Wh-question</p>
        <p>e. Does she like ice cream or sweets?</p>
        <p>= Choice Question</p>
        <p>f. She sent him an invitation, didn't she?</p>
        <p>= Tag Question</p>
        <p>g. Could you tell me if the doctor is available?</p>
       ...
       <div>
        ...
        <p>d. What time <strong>do</strong> you get up?- I get up at 6:00.</p>
        <p>e. <strong>Did</strong> the children go to the park?- Yes, they went there after school.</p>
        <p>f. Are <strong>you</strong> going to school?- No, I'm going home.</p>
...
export default Moneyandeconomy
