...
const Leisureandentertainment = () => (
    <div>
        <div>
            ...
            <p>6. highly decorated: <strong>Ornate</strong></p>
            <p>7. beat with a strong, regular rhythm; survive: <strong>Throb</strong></p>
            <p>10. with the agreement of all people involved: <strong>Unanimously</strong></p>
            <p>11. the destructive effects of something: <strong>Ravages</strong></p>
            <br />
            <p><strong>Down</strong></p>
            <p>1. a large city:<strong>Metropolis</strong></p>
            <p>2. wandering from place to place without any purpose:<strong>Loitering</strong></p>
            <p>4. an unpleasant place; a place of extreme misery: <strong>Hellhole</strong></p>
            <p>5. an active revolt or uprising: <strong>Insurgency</strong></p>
