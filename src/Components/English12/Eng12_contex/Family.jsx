...
const Family = () => {
  ...
  return (
    <div className='container scrollable-content'>
      ...
      <div>
        <h4>ACROSS</h4>
        <p>1. The custom of having more than one wife at the same time.</p>
        <h4>POLYGAMY</h4>
        <p>5. To find an acceptable way of dealing with opposing ideas, needs etc.</p>
        <h4>RECONCILE</h4>
        <p>6. The process in which towns, streets, etc. are built where there was once countryside.</p>
        <h4>URBANIZATION</h4>
        <p>7. The process by which somebody learns to behave in an acceptable way in their society.</p>
        <h4>SOCIALIZATION</h4>
      </div>

      <div>
        <h4>DOWN</h4>
        <p>1. Ruled or controlled by men.</p>
        <h4>PATRIARCHAL</h4>
        <p>2. The act of taking over a position.</p>
        <h4>SUCCESSION</h4>
        <p>3. Done in a way without caring if people are shocked.</p>
        <h4>BLATANT</h4>
        <p>4. Single-parent.</p>
        <h4>LONEPARENT</h4>
      </div>
...
<hr/>
      <div>
        ...
        <p><strong>mis-:</strong> misunderstand, mislead, misbehave, mistake, misinformation</p>
        <p><strong>mono-:</strong> monopoly, monotone, monochrome, monologue, monarchy</p>
        <p><strong>un-:</strong> unhappy, unkind, unpack, untie, unlock</p>
        <p><strong>in-:</strong> incorrect, invisible, inactive, inefficient, inhuman</p>
        <p><strong>inter-:</strong> intersection, international, internet, interview, interact</p>
      </div>
...
In my opinion, both types of families are important and useful in their own ways. What matters most is the love, respect, and understanding shared among family members.</p>
      ...
      <div>
        ...
        <p>d. "I don't think he meant to be rude." "He <strong>must have</strong> said sorry."</p>
        <p>e. "Whose signature is this?" "I don't know. It <strong>could</strong> be Manoj's. That looks a bit like an M."</p>
...
<hr/>
      <div>
        ...
        <p>d. I'm quite busy tomorrow. I <strong>might not join you.</strong></p>
        <p>e. When you were a small kid, <strong>you might have been notorious.</strong></p>
        <p>f. My car is broken. I <strong>might buy a new one.</strong></p>
        <p>g. I've got a fast internet connection at home. I <strong>should not misuse it.</strong></p>
        <p>h. Even though she didn't study well, she <strong>might have passed the exam.</strong></p>
        <p>i. There are plenty of newspapers in the library. You <strong>can pick one if you want.</strong></p>
        <p>j. What were you thinking playing on the road? You <strong>could have been hurt in an accident.</strong></p>
        <p>k. I have no time. I <strong>must not waste any more of it.</strong></p>
        <p>l. You don't look well. You <strong>might be delirious.</strong></p>
      </div>
    </div>
  );
};
