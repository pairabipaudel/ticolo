...
const Theawakeningage = () => {
  return (
    <div>
      <div>
        <h3>Summary</h3>
        <p>The Awakening Age is a time when people begin to open their eyes to new ideas and ways of thinking. It is like a fresh start, where people question old traditions and try to understand the world better. During this period, people become aware of their rights, culture, and the importance of knowledge.</p>
        <p>This age brings changes in society, education, and politics. People begin to speak up for justice, equality, and freedom. They want to improve their lives and the lives of others. It is a time full of hope and energy, as new thinkers, writers, and leaders inspire others to grow and learn.</p>
        <p>The Awakening Age encourages people to break free from ignorance and fear. It teaches them to think critically and be open to new possibilities. Overall, it is a time of growth, progress, and positive change for individuals and society as a whole.</p>
      </div>
      <div>
        <hr/>
...
export default Theawakeningage
